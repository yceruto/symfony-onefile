            ...
            <body class="bg-indigo-700">
                <div class="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
                    <div class="mx-auto max-w-2xl text-center">
                        ...
                        <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl mt-2">Hello $name</h2>
                        <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-indigo-200">Welcome to Symfony One File Challenge 2025<br>Packing a Symfony full-stack Framework Application in one File.</p>
                    </div>
                </div>
            </body>
            </html>
